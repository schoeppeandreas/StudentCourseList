...
public class StudentController {
    ...
    @RequestMapping(value="/deleteStudentCourse/{courseid}/{studentid}", method=RequestMethod.GET)
	public String deleteCourseFromStudent(@PathVariable Long courseid, @PathVariable Long studentid, Model model) {
